...
switch(tipoOponente){
    case 1:
    enemigos [PV] = 150;
    enemigos [ataqueMinimo] = 5;
    enemigos [ataqueMaximo] = 15;
    break;
    case 2:
    enemigos [PV] = 300;
    enemigos [ataqueMinimo] = 25;
    enemigos [ataqueMaximo] = 45;
    break;
    case 3:
    enemigos [PV] = 450;
    enemigos [ataqueMinimo] = 40;
    enemigos [ataqueMaximo] = 55;
    break;
    case 4:
    enemigos [PV] = 700;
    enemigos [ataqueMinimo] = 55;
    enemigos [ataqueMaximo] = 75;
    break;
    case 5:
    enemigos [PV] = 1500;
    enemigos [ataqueMinimo] = 25;
    enemigos [ataqueMaximo] = 150;
   break;
}
...
void nombre (){
cout<<"Bienvenido al modo aventura:"<<endl;
